...
public class WindTalker {
  ...
  public CommandPacket assembleSessionOpenPacket(String installationId, String clientId, String tag, String sessionToken, long lastNotifyTime,
                                                 long lastPatchTime, boolean reConnect, Integer requestId) {
    SessionControlPacket scp = SessionControlPacket.genSessionCommand(
            installationId, clientId, null, SessionControlPacket.SessionControlOp.OPEN,
  ...
  public CommandPacket assembleSessionOpenPacket(String installationId, String clientId, String tag, Signature signature, long lastNotifyTime,
                                                 long lastPatchTime, boolean reConnect, int requestId) {
    SessionControlPacket scp = SessionControlPacket.genSessionCommand(
            installationId, clientId, null,
...
//    }
  ...
  public CommandPacket assembleSessionPacket(String installationId, String selfId, List<String> peers,
                                             String op, Signature signature, Integer requestId) {
    SessionControlPacket scp = SessionControlPacket.genSessionCommand(installationId, selfId, peers, op, signature, requestId);
    return scp;
  }
