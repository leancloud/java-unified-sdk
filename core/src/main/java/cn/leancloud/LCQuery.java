...
public class LCQuery<T extends LCObject> implements Cloneable {
   ...
   */
  public static Observable<LCCloudQueryResult> doCloudQueryInBackground(String cql) {
    return LCCloudQuery.executeInBackground(cql);
  }
   ...
   */
  public static Observable<LCCloudQueryResult> doCloudQueryInBackground(String cql, Object... params) {
    return LCCloudQuery.executeInBackground(cql, params);
  }
   ...
   */
  public static Observable<LCCloudQueryResult> doCloudQueryInBackground(String cql, Class<? extends LCObject> clazz) {
    return LCCloudQuery.executeInBackground(cql, clazz);
  }
   ...
   */
  public static Observable<LCCloudQueryResult> doCloudQueryInBackground(String cql, final Class<? extends LCObject> clazz,
                                                                        Object... params) {
    return LCCloudQuery.executeInBackground(cql, clazz, params);
  }
}
