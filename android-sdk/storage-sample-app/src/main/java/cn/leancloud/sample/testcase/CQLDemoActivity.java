...
public class CQLDemoActivity extends DemoBaseActivity {
  ...
  public void testSelect() throws Exception {
    ...
    LCCloudQueryResult result = LCQuery.doCloudQueryInBackground(cql).blockingFirst();
  ...
  public void testSelectWhere() throws Exception {
    ...
    LCCloudQueryResult result = LCQuery.doCloudQueryInBackground(cql, "XiaoMing").blockingFirst();
    logResult(cql, result);
  }

  public void testSelectWhereIn() throws Exception {
    String cql = String.format("select * from _User where username in (?,?)");
    LCCloudQueryResult result = LCQuery.doCloudQueryInBackground(cql, "XiaoMing", "lzwjava@gmail.com").blockingFirst();
    logResult(cql, result);
  }
  ...
  public void testSelectWhereDate() throws Exception {
    ...
    LCCloudQueryResult result = LCQuery.doCloudQueryInBackground(cql, "2015-05-01T00:00:00.0000Z", "3").blockingFirst();
    logResult(cql, result);
  }
}
